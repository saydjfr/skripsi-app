  ...
  <div class="navbar-start">
    <div class="dropdown">
      ...
      <ul
        ...
        <li><a wire:navigate class="{{ request()->is('/')?'active':'disactive'}}" href="/" >Beranda</a></li>
        <li><a wire:navigate class="{{ request()->is('categories')?'active':'disactive'}}" href="/categories" >Kategori</a></li>
        <li><a wire:navigate class="{{ request()->is('products')?'active':'disactive'}}" href="/products" >Produk</a></li>
      </ul>
    </div>
