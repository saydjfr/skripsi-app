<div class="w-full max-w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="flex flex-wrap mb-24 -mx-3">
          ...
          <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              <h2 class="text-2xl font-bold dark:text-gray-400">Toko</h2>
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <ul>
                @foreach($shops as $shop)
                <li class="mb-4" wire:key="{{$shop->id}}">
                  <label for="{{$shop->name}}" class="flex items-center dark:text-gray-300">
                    <input type="checkbox" class="w-4 h-4 mr-2" id="{{$shop->name}}" value="{{$shop->id}}">
