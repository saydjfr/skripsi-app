            ...
            <div class="sticky top-0 z-50 overflow-hidden ">
              ...
              <div class="flex-wrap hidden md:flex ">
                ...
                <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{url('storage',$img)}}'">
                  <img src="{{url('storage', $img)}}" alt="{{$product->name}}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
                </div>  
                @endforeach
            ...
            <div class="lg:pl-20">
              ...
              <div class="w-32 mb-8 ">
                ...
                <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                  <button type="button" wire:click='kurangQty' class="w-20 h-full text-gray-600 bg-gray-300 rounded-l outline-none cursor-pointer dark:hover:bg-gray-700 dark:text-gray-400 hover:text-gray-700 dark:bg-gray-900 hover:bg-gray-400">
                    <span class="m-auto text-2xl font-thin">-</span>
                  </button>
                  <input type="number" value="{{$quantity}}"  class="flex items-center w-full font-semibold text-center text-gray-700 placeholder-gray-700 bg-gray-300 outline-none dark:text-gray-400 dark:placeholder-gray-400 dark:bg-gray-900 focus:outline-none text-md hover:text-black" />
